      ...
      {!document ? (
        ...
        <>
          ...
          <section className="grid gap-6 lg:grid-cols-[minmax(0,1.35fr),minmax(18rem,0.9fr)]">
            <div className="rounded-sm border border-ink-700/10 bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center rounded-sm border border-ink-700/10 bg-white px-4 py-2.5 text-sm font-medium text-ink-900 transition-colors hover:bg-ink-50"
                >
