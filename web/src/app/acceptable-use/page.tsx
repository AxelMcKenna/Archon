...
export const metadata: Metadata = {
  ...
  description: "Rules for acceptable use of the Atlas platform.",
};
...
export default function AcceptableUsePage() {
  return (
    <LegalShell
      ...
      intro="This policy sets out activities that are prohibited on the Atlas platform. It is part of, and incorporated into, our Terms of Service."
    >
      <h2>1. Prohibited activities</h2>
      <p>You must not, and must not allow anyone else to:</p>
      <ul>
        <li>Use Atlas to break any law or infringe anyone&apos;s rights.</li>
        <li>
