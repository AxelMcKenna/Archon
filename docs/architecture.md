...
flowchart TB
  ...
  subgraph Extract["Extract"]
    ...
    vision["claude_vision<br/>(scanned / image PDFs)"]
  ...
  subgraph Plan["Plan analyser"]
    plan_an["plan_analyzer<br/>flags + severity"]
    bbox["plan_bbox_refiner<br/>(grounded coords)"]
    overlay["plan_overlay<br/>render boxes on PDF"]
