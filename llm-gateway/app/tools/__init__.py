"""Tool registry for the llm-gateway loop.
...
from app.tools.get_plan_flag import get_plan_flag_execute, get_plan_flag_schema
...
TOOLS: dict[str, dict[str, Any]] = {
    ...
    "list_plan_flags": {
        "schema": list_plan_flags_schema(),
        "execute": list_plan_flags_execute,
    },
    "get_plan_flag": {
        "schema": get_plan_flag_schema(),
        "execute": get_plan_flag_execute,
    },
