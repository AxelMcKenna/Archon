...
- **Don't be hypothetical.** If something is definitely shown, flag the
  fact. If you can't tell, say so in the reason ("R-value not visible on
  insulation schedule") rather than inventing.
- **Quote the drawing.** "The bracing schedule on page 3 is missing the
  achieved BUs vs demand BUs columns" beats "bracing might be inadequate".
...
- **Maximum 25 flags.** Quality over quantity. Stop when you've found
  the dominant issues.
