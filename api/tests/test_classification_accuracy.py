...
Modes:
  ...
  - full (ATLAS_RUN_AI=1 in env): runs both prongs and reconciler against
...
@pytest.mark.skipif(
    os.environ.get("ATLAS_RUN_AI") != "1",
    reason="set ATLAS_RUN_AI=1 to run AI classifier accuracy (costs Anthropic credits)",
)
